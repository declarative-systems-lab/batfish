...
public final class AddCommunity extends Statement {
  ...
  public void initSmtVariable(
    ...
    if (_enableSmtVariable) {
      throw new BatfishException("AddCommunity.initSmtVariable: shared object.\n" +
    ...
    if (_expr.getEnableSmtVariable()) {
      System.out.println("WARNING: AddCommunity.initSmtVariable: " +
      ...
      if (exprBackup.getEnableSmtVariable() == _expr.getEnableSmtVariable()) {
        throw new BatfishException("AddCommunity.initSmtVariable: " +
    ...
    if (false == isTrue) {
      throw new BatfishException("AddCommunity.initSmtVariable: invalid is true flag.");
    }
